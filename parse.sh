...
echo parsing ...
./bin/segphrase_parser results/segmentation.model results/salient.csv ${NUM_PHRASE} tmp/test.token tmp/test.parsed.txt 0 ${TOP_K} ${OFFSET}
echo decoding ...
